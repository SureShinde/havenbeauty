...
class Mage_Adminhtml_Block_Newsletter_Subscriber_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('favoriteSister', array(
            'header'    => Mage::helper('newsletter')->__('Customer Favorite Sister'),
            'index'     => 'favorite_sister',
            'type'      => 'favorite_sister',
            'default'   =>    '----'
        ));

        $this->addColumn('dtmFname', array(
            'header'    => Mage::helper('newsletter')->__('Guest First Name'),
            'index'     => 'dtm_fname',
            'default'   =>    '----'
        ));

        $this->addColumn('dtmLname', array(
            'header'    => Mage::helper('newsletter')->__('Guest Last Name'),
            'index'     => 'dtm_lname',
            'default'   =>    '----'
        ));
