 ...
 */
class Kodematix_ShippingTablerate_Adminhtml_TablerateController extends Mage_Adminhtml_Controller_Action
{
    /**
     ...
     * Init actions
     *
     * @return Kodematix_ShippingTablerate_Adminhtml_ShippingtablerateController
     */
