 ...
 */
class Kodematix_ShippingTablerate_Model_Mysql4_Tablerate_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     ...
     *
     * @param int $websiteId
     * @return Kodematix_ShippingTablerate_Model_Mysql4_Tablerate_Collection
     */
