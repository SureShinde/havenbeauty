 ...
 */
class Kodematix_ShippingTablerate_Block_Adminhtml_Tablerate_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     ...
     *
     * @return Kodematix_ShippingTablerate_Block_Adminhtml_Tablerate_Edit_Form
     */
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('main_fieldset', array('legend' => $helper->__('Shipping Table Rate')));
        if ($model->getId()) {
