 ...
 */
class Kodematix_ShippingTablerate_Block_Adminhtml_Tablerate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     ...
     *
     * @return Kodematix_ShippingTablerate_Block_Adminhtml_Tablerate_Edit
     */
