 ...
 */
class Kodematix_ShippingTablerate_Block_Adminhtml_Tablerate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Website
     * 
     ...
     *
     * @return Kodematix_ShippingTablerate_Block_Adminhtml_Tablerate_Grid
     */
